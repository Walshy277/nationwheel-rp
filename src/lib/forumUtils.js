...
export const FORUM_BOARDS = [
  ...
  { slug: "war-room", name: "War Room", desc: "Military strategy, wars, and battle reports.", icon: "⚔", sort: 9 },
  ...
  { slug: "season-archives", name: "Season Archives", desc: "Completed seasons and historical records.", icon: "📦", sort: 19, visibility: "archived" },
